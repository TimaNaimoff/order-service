...
import com.example.orderservice.order.dto.OrderItemDto;
...
public interface OrderItemMapper {
    ...
    default OrderStatusDto jsonToStatusDto(String json) {
        if (json == null) return null;
        try {
            return new ObjectMapper().readValue(json, OrderStatusDto.class);
        } catch (JsonProcessingException e) {
